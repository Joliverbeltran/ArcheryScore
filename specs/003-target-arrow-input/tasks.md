...
- [ ] T030 [P] [US3] Extend PlacementScorerTest (T015) with an exhaustive boundary matrix — every ring boundary for `TEN_ZONE` (10 rings) and every band boundary for `FIVE_ZONE` (5 bands) scores the higher value, plus `r ≥ 1` miss and X-rule re-verification (SC-003)
